...
/** `resolvr stop` — stops the process Resolvr itself started (PID-file tracked), validating
 * the PID still refers to that same process before touching it, and handles "already
 * stopped" as a clean success rather than an error. */
